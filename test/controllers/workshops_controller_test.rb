...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, image: @workshop.image, level: @workshop.level, price: @workshop.price, information: @workshop.information, title: @workshop.title }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { description: @workshop.description, image: @workshop.image, level: @workshop.level, price: @workshop.price, information: @workshop.information, title: @workshop.title }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
